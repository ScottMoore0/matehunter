...
Every number here is from ChestUCI, a mate corpus neither engine was tuned on,
with one thread, every mate option set explicitly, and results paired position
